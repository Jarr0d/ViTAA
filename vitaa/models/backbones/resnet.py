...
class ResNet(nn.Module):
    ...
    def __init__(self, model_arch, res5_stride=2, res5_dilation=1, use_c4=False, pretrained=True):
...
def build_resnet(cfg):
    ...
    model = ResNet(model_arch, res5_stride, res5_dilation, use_c4, pretrained=True)
